...
class GameApp:
    def __init__(self, root, players):
        ...
        with open("data/destinations.json", "r", encoding="utf-8") as f:
            raw_route_data = json.load(f)  # Toutes les routes du jeu
        self.all_routes = [
            Route(route["city1"], route["city2"], route["color"], route["length"])
            for route in raw_route_data
        ]
        ...
        self.setup_ui()
        self.draw_initial_destinations()
    ...
    # -------------------------------------- TIRAGE -----------------------------------------------
    def draw_initial_destinations(self):
        for player in self.game.players:
            ...
            for obj in initial_destinations:
                ...
                # Gérer à la fois les anciens et nouveaux formats
                if "cities" in obj:
            ...
            def validate():
                ...
                if len(selected) < 2:
                    messagebox.showwarning("Choix invalide", "Vous devez choisir au moins 2 destinations.")
                    return
            ...
            # Attendre que le joueur ait validé
    ...
    def on_draw_card_click(self):
        self.game.draw_card(self.draw_count)
        self.draw_count += 1
    ...
    def is_objective_completed(self, obj):
        ...
        graph = {}
        for route in self.game.current_player.routes:
            city1 = route.city1
            city2 = route.city2
